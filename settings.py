...
TABLE_COLS = ['Added_at', 'Text', 'Polarity']
...
stop_words = stop_words = ['i', 'me', 'my', 'myself', 'The', 'we', 'our', 'ours', 'ourselves',
                           ...
                           'above', 'below', 'to', 'from', 'From', 'covid', 'up', 'down', 'in', 'out', 'on',
                           ...
                           "re", "11", "isnt", "wan", "ver", "like", "'re", "m", "'ve", "bec", "n", "twt", "kca", "c",
                           "a",
